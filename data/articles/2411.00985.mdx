...
categories: ['cs.CL']
problem: federated discrete and transferable prompt tuning
...
In recent years, large language models (LLMs) have significantly advanced the
