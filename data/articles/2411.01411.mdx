...
categories: ['cs.CV']
problem: novel deep learning flood detection model
...
Floods cause extensive global damage annually, making effective monitoring
...
worldwide to advance flood monitoring and enhance disaster response strategies.