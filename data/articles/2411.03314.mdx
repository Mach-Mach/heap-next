...
problem: MME-Finance benchmark for multimodal finance evaluation
solution: ['inadequate performance measurement of multimodal models in the financial domain']
