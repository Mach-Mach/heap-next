...
problem: FIRST approach integrating learning-to-rank objective and single-token logits
solution: high computational demands of large language models for listwise reranking
