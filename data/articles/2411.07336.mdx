...
date: 2024-11-13
tags: ['lexical variations', 'NLP tasks', 'semantic variations', 'algorithmic tasks', 'instruction-following abilities', 'set operations', 'set theory', 'robustness evaluation', 'synthetic benchmark', 'language models']
categories: ['cs.CL']
problem: SetLexSem Challenge benchmark for evaluating language model performance
solution: ['poor robustness of language models to variation in set operations and operands']
