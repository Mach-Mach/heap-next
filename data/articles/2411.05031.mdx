...
date: 2024-11-06
tags: ['data imbalance', 'data augmentation', 'MobileBert', 'emoji classification', 'user preferences', 'latency requirements', 'SwiftKey', 'memory constraints', 'on-device processing']
categories: ['cs.CL']
problem: on-device emoji classifier based on MobileBert with GPT-based data augmentation
solution: data imbalance in emoji classification
pdf_url: http://arxiv.org/pdf/2411.05031v1
arx_url: http://arxiv.org/abs/2411.05031v1
score: 5
authors: ['Hossam Amer', 'Joe Osborne', 'Michael Zaki', 'Mohamed Afify']
affiliations_aligned: ['Microsoft', 'Microsoft', 'Microsoft', 'Microsoft']
