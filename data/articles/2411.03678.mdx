...
categories: ['cs.LG']
problem: novel adaptive conformal prediction framework using multiple candidate models
...
Conformal prediction is an uncertainty quantification method that constructs
