...
date: 2024_11_08
tags: ['search space exploration', 'multi-stage planning', 'code generation', 'execution-based feedback', 'tree structure', 'large language models', 'benchmarks', 'agent-guided approaches', 'performance evaluation', 'decision-making']
categories: ['cs.CL']
problem: CodeTree framework for efficient search space exploration
solution: ['challenges in multi-stage planning and debugging in code generation']
...
affiliations_aligned: ['The University of Texas at Austin', 'Salesforce Research', 'Salesforce Research', 'Salesforce Research', 'Salesforce Research', 'Salesforce Research']
affiliations: ['The University of Texas at Austin', 'Salesforce Research']
---
